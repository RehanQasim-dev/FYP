...
riscv64-unknown-elf-as -c -o build/testing.o src/testing.s -march=rv32im -mabi=ilp32
#riscv64-unknown-elf-gcc -c -o build/main.o src/main1.c -march=rv32im -mabi=ilp32 -O0 # Example: use -O0 for optimization level 2
riscv64-unknown-elf-gcc -o build/main.elf build/startup.o build/testing.o -T linker.ld -nostdlib -march=rv32im -mabi=ilp32 -O0  # Example: use -O0 for optimization level 2
