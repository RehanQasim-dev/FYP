...
riscv64-unknown-elf-gcc -c -o build/main.o src/main2.c -march=rv32im -mabi=ilp32 -O0 # Example: use -O0 for optimization level 2
...
py maketxt1.py build/ICACHE.bin > build/ICACHE.mem
py maketxt2.py build/DCACHE.bin > build/DCACHE.mem
