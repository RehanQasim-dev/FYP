...
riscv64-unknown-elf-gcc -c -o build/main.o src/main.c -march=rv32im -mabi=ilp32 -O3  # Example: use -O2 for optimization level 2
riscv64-unknown-elf-gcc -o build/main.elf build/startup.o build/main.o -T linker.ld -nostdlib -march=rv32im -mabi=ilp32 -O3  # Example: use -O2 for optimization level 2
