...
VL_ATTR_COLD void Vtb_random_gemm___024root___eval_initial__TOP(Vtb_random_gemm___024root* vlSelf) {
    ...
    // Init
    VlWide<3>/*95:0*/ __Vtemp_h9e41dfdb__0;
    // Body
    __Vtemp_h9e41dfdb__0[0U] = 0x2e6d656dU;
    __Vtemp_h9e41dfdb__0[1U] = 0x41434845U;
    __Vtemp_h9e41dfdb__0[2U] = 0x4443U;
    VL_READMEM_N(true, 8, 16384, 0, VL_CVT_PACK_STR_NW(3, __Vtemp_h9e41dfdb__0)
...
VL_ATTR_COLD void Vtb_random_gemm___024root___ctor_var_reset(Vtb_random_gemm___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 70; ++__Vi0) {
        VL_RAND_RESET_W(560, vlSelf->tb_random_gemm__DOT__A[__Vi0]);
    }
    for (int __Vi0 = 0; __Vi0 < 70; ++__Vi0) {
        VL_RAND_RESET_W(560, vlSelf->tb_random_gemm__DOT__B[__Vi0]);
    }
    for (int __Vi0 = 0; __Vi0 < 70; ++__Vi0) {
        VL_RAND_RESET_W(2240, vlSelf->tb_random_gemm__DOT__C[__Vi0]);
    }
    vlSelf->tb_random_gemm__DOT__A_addr = 0;
    vlSelf->tb_random_gemm__DOT__B_addr = 0;
    vlSelf->tb_random_gemm__DOT__C_addr = 0;
    vlSelf->tb_random_gemm__DOT__file_handle = 0;
    vlSelf->tb_random_gemm__DOT__old_sel_for_test = 0;
    vlSelf->tb_random_gemm__DOT__cycles_count = VL_RAND_RESET_I(32);
    ...
    vlSelf->tb_random_gemm__DOT____Vlvbound_h848f6088__0 = VL_RAND_RESET_I(8);
    vlSelf->tb_random_gemm__DOT____Vlvbound_h16e23e8d__0 = VL_RAND_RESET_I(8);
    vlSelf->tb_random_gemm__DOT____Vlvbound_hda49e2e8__0 = VL_RAND_RESET_I(32);
    vlSelf->tb_random_gemm__DOT____Vlvbound_hda49e2e8__1 = VL_RAND_RESET_I(32);
