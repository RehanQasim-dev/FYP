                                   ...
                                   << 1U) | ((8U < 
                                             ...
                                             & (8U 
                                                < (0x1fU 
                                                   & (vlSelf->tb_random_gemm__DOT__DUT__DOT__memory_mapped_instance__DOT__tile_dimension 
                                                      >> 0xaU)))))));
    if ((1U & Vtb_random_gemm__ConstPool__TABLE_h586b642f_0
         [__Vtableidx1])) {
        vlSelf->tb_random_gemm__DOT__DUT__DOT__mode 
            = Vtb_random_gemm__ConstPool__TABLE_h1ef0a14a_0
            [__Vtableidx1];
    }
    if ((2U & Vtb_random_gemm__ConstPool__TABLE_h586b642f_0
         [__Vtableidx1])) {
        vlSelf->tb_random_gemm__DOT__DUT__DOT__if_mux_sel 
            = Vtb_random_gemm__ConstPool__TABLE_hdfa1c0e0_0
            [__Vtableidx1];
    }
    if ((4U & Vtb_random_gemm__ConstPool__TABLE_h586b642f_0
         [__Vtableidx1])) {
        vlSelf->tb_random_gemm__DOT__DUT__DOT__w_mux_sel 
            = Vtb_random_gemm__ConstPool__TABLE_hf4420325_0
            [__Vtableidx1];
    }
...
VL_ATTR_COLD void Vtb_random_gemm___024root___stl_sequent__TOP__1(Vtb_random_gemm___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->tb_random_gemm__DOT__DUT__DOT__buffer_instance__DOT__cs)))) {
